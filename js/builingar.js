/* $(window).bind('beforeunload', function() {
 ...
 $(document).ready(function() {
  ...
  var cols = [
  { "mDataProp": "" , sTitle: "\u0625\u0636\u0627\u0641\u0629 \u0637\u0627\u0628\u0642", sType : "string", "defaultContent": "<a href='javascript:void(0);' id='buildingaddstoreys' data-toggle='modal' data-target='#addstoreysModal' class='btn btn-ts'>\u0625\u0636\u0627\u0641\u0629 \u0637\u0627\u0628\u0642</a>"},
  { "mDataProp": "BuildingNumber", sTitle: "رقم المبنى",sType : "numeric"},
  { "mDataProp": "BuildingName", sTitle: "اسم المبنى",sType : "string"},
  { "mDataProp": "BuildingType" , sTitle: "نوع الاستعمال",sType : "string"},
  { "mDataProp": "BuildingStatus" ,  sTitle: "حالة المبنى",sType : "string"},
  { "mDataProp": "Units" , sTitle: "الوحدات",sType : "numeric"},
  { "mDataProp": "Floors" ,  sTitle: "الطوابق",sType : "numeric"},
  { "mDataProp": "Actions" , sTitle: "الإجراء", sType : "string", "defaultContent": "<a id = 'editbuilgdetails' href='javascript:void(0);' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removebuilgdetails' href='javascript:void(0);' class='text-red'><i class='fa fa-trash-o'></i></a>" },
 ...
 $(document).ready(function() {
  ...
  var cols = [
    { "mDataProp": "BuildingNumber", sTitle: "رقم المبنى",sType : "numeric"},
    { "mDataProp": "auIdnumber" ,  sTitle: "رقم التعريف",sType : "numeric"},
    { "mDataProp": "auNumberofunits" , sTitle: "عدد الوحدات",sType : "numeric"},
    { "mDataProp": "untstypeype" , sTitle: "نوع الوحدة",sType : "string"},
    { "mDataProp": "Actions" , sTitle: "الإجراء", sType : "string", "defaultContent": "<a id = 'editbuilgunitdetails' href='javascript:void(0);' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removebuilgunitdetails' href='javascript:void(0);' class='text-red'><i class='fa fa-trash-o'></i></a>" }
  ];
  var table = $('#units_detailstable').DataTable({
    "aoColumns": cols,
    "columnDefs": [{
  ...
  table.page.len(5).draw();
  $( ".dataTables_length" ).replaceWith( "<label style='font-size: 14px;font-weight: bold;'>الوحدات</label><input type=text  class='page form-control' value='5' style='display:none'>  <label style='display:none'>entries</label>" );
  $(".page").keyup(function() {
    table.page.len(eval($(".page").val())).draw();
  });
 });
 $(document).ready(function() {
  ...
  var cols = [
     { "mDataProp": "", sTitle: "\u0625\u0636\u0627\u0641\u0629 \u0648\u062d\u062f\u0629", sType: "string", "defaultContent": "<a href='javascript:void(0);' id='buildingaddunits' data-toggle='modal' data-target='#addunitsModal' class='btn btn-ts'>\u0625\u0636\u0627\u0641\u0629 \u0648\u062d\u062f\u0629</a>"},
     { "mDataProp": "BuildingNumber", sTitle: "رقم المبنى",sType : "numeric"},
     ...
     { "mDataProp": "Actions" , sTitle: "الإجراء", sType : "string", "defaultContent": "<a id = 'editbuilgstoreydetails' href='javascript:void(0);' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removebuilgstrdetails' href='javascript:void(0);' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
  var table = $('#storeys_table').DataTable({
    "aoColumns": cols,
    "columnDefs": [{
  ...
  table.page.len(5).draw();
  $( ".dataTables_length" ).replaceWith( "<label style='font-size: 14px;font-weight: bold;'>الطابق</label><input type=text  class='page form-control' value='5' style='display:none'>  <label style='display:none'>entries</label>" );
  $(".page").keyup(function() {
    table.page.len(eval($(".page").val())).draw();
  });
 });