 ...
 $(document).ready(function() {
  ...
  var cols = [ 
    { "mDataProp": "", sTitle: "Add Storeys", sType: "string", "defaultContent": "<a href='javascript:void(0);' id='Proposedaddstoreys' data-toggle='modal' data-target='#addPstoreysModal' class='btn btn-ts'>Add Storeys</a>" }, 
    { "mDataProp": "ProposedNumber", sTitle: "Building Number", sType: "numeric" }, 
    { "mDataProp": "ProposedName", sTitle: "Building Name", sType: "string" }, 
    { "mDataProp": "ProposedType", sTitle: "Type of Use", sType: "string" }, 
    { "mDataProp": "ProposedStatus", sTitle: "Building Status", sType: "string" }, 
    { "mDataProp": "ProposedUnits", sTitle: "Units", sType: "numeric" }, 
    { "mDataProp": "ProposedFloors", sTitle: "Floors", sType: "numeric" }, 
    { "mDataProp": "Actions", sTitle: "Actions", sType: "string", "defaultContent": "<a id = 'editbuilgdetails1' href='javascript:void(0);' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removebuilgdetails' href='javascript:void(0);' class='text-red'><i class='fa fa-trash-o'></i></a>" }, 
 ...
 $(document).ready(function() {
  ...
  var cols = [
    ...
    { "mDataProp": "Actions", sTitle: "Actions", sType: "string", "defaultContent": "<a id = 'editPbuilgunitdetails' href='javascript:void(0);' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removebuilgdetails' href='javascript:void(0);' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
  var table = $('#units_Proposed').DataTable({
    "aoColumns": cols,
    "columnDefs": [{
 ...
 $(document).ready(function() {
  ...
  var cols = [
    { "mDataProp": "", sTitle: "Add Units", sType: "string", "defaultContent": "<a href='javascript:void(0);' id='Proposedaddunits' data-toggle='modal' data-target='#addPunitsModal' class='btn btn-ts'>Add Units</a>" },
    { "mDataProp": "BuildingNumber", sTitle: "Building Number", sType: "numeric" },
    ...
    { "mDataProp": "Actions", sTitle: "Actions", sType: "string", "defaultContent": "<a id = 'editPbuilgstoreydetails' href='javascript:void(0);' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removebuilgdetails' href='javascript:void(0);' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
  var table = $('#storeys_Proposed').DataTable({
    "aoColumns": cols,
    "columnDefs": [{
