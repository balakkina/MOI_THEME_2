//Catchment Button
 ...
 $(document).ready(function() {
    ...
    { "mDataProp": "BoardType", sTitle: "Board Type", sType: "string" }, 
    { "mDataProp": "Board_EN", sTitle: "Board Title English", sType: "string" }, 
    { "mDataProp": "Board_AR", sTitle: "Board Title Arabic", sType: "string" }, 
    { "mDataProp": "Board_Hei", sTitle: "Height", sType: "string" },
    { "mDataProp": "Board_Wid", sTitle: "Width", sType: "string" },
    { "mDataProp": "Board_Ground", sTitle: "Ground Clearance Area", sType: "string" },
    { "mDataProp": "Board_Desc", sTitle: "Board Description", sType: "string" },
    { "mDataProp": "Actions", sTitle: "Actions", sType: "string", "defaultContent": "<a id = 'editBoarddetails' href='javascript:void(0)' class='text-green'><i class='fa fa-edit'></i></a><a id = 'removeBoarddetails' href='javascript:void(0)' class='text-red'><i class='fa fa-trash-o'></i></a>" }
    ];
    var table = $('#Board_table').DataTable({
