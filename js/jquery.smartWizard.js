(function($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function() {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button id="setupform" ></button>').text(this.options.lang.next).append('<span class="fa fa-arrow-circle-right"></span>').addClass('btn btn-default sw-btn-next').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-default sw-btn-prev').prepend('<span class="fa fa-arrow-circle-left"></span>').attr('type', 'button') : null;
